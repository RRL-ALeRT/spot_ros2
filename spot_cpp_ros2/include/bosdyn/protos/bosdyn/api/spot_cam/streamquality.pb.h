...
namespace api {
namespace spot_cam {
class EnableCongestionControlRequest;
struct EnableCongestionControlRequestDefaultTypeInternal;
extern EnableCongestionControlRequestDefaultTypeInternal _EnableCongestionControlRequest_default_instance_;
class EnableCongestionControlResponse;
struct EnableCongestionControlResponseDefaultTypeInternal;
extern EnableCongestionControlResponseDefaultTypeInternal _EnableCongestionControlResponse_default_instance_;
class GetStreamParamsRequest;
struct GetStreamParamsRequestDefaultTypeInternal;
extern GetStreamParamsRequestDefaultTypeInternal _GetStreamParamsRequest_default_instance_;
class GetStreamParamsResponse;
struct GetStreamParamsResponseDefaultTypeInternal;
extern GetStreamParamsResponseDefaultTypeInternal _GetStreamParamsResponse_default_instance_;
class SetStreamParamsRequest;
struct SetStreamParamsRequestDefaultTypeInternal;
extern SetStreamParamsRequestDefaultTypeInternal _SetStreamParamsRequest_default_instance_;
class SetStreamParamsResponse;
struct SetStreamParamsResponseDefaultTypeInternal;
...
struct StreamParams_AwbModeDefaultTypeInternal;
extern StreamParams_AwbModeDefaultTypeInternal _StreamParams_AwbMode_default_instance_;
}  // namespace spot_cam
}  // namespace api
}  // namespace bosdyn
PROTOBUF_NAMESPACE_OPEN
template<> ::bosdyn::api::spot_cam::EnableCongestionControlRequest* Arena::CreateMaybeMessage<::bosdyn::api::spot_cam::EnableCongestionControlRequest>(Arena*);
template<> ::bosdyn::api::spot_cam::EnableCongestionControlResponse* Arena::CreateMaybeMessage<::bosdyn::api::spot_cam::EnableCongestionControlResponse>(Arena*);
...
enum StreamParams_AwbModeEnum : int {
  ...
  StreamParams_AwbModeEnum_DARK PROTOBUF_DEPRECATED_ENUM = 9,
  StreamParams_AwbModeEnum_StreamParams_AwbModeEnum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  StreamParams_AwbModeEnum_StreamParams_AwbModeEnum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class StreamParams_AwbMode final :
 ...
 public:
  ...
  ~StreamParams_AwbMode() override;
  explicit PROTOBUF_CONSTEXPR StreamParams_AwbMode(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  StreamParams_AwbMode* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const StreamParams_AwbMode& from) {
    StreamParams_AwbMode::MergeImpl(*this, from);
  }
  private:
...
class StreamParams final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StreamParams(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const StreamParams& from) {
    StreamParams::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  PROTOBUF_DEPRECATED_ENUM static constexpr AwbModeEnum DARK =
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Int64Value* release_targetbitrate();
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Int64Value* release_refreshinterval();
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Int64Value* release_idrinterval();
  ...
  PROTOBUF_NODISCARD ::bosdyn::api::spot_cam::StreamParams_AwbMode* release_awb();
...
class GetStreamParamsRequest final :
 ...
 public:
  ...
  ~GetStreamParamsRequest() override;
  explicit PROTOBUF_CONSTEXPR GetStreamParamsRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  GetStreamParamsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const GetStreamParamsRequest& from) {
    GetStreamParamsRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class GetStreamParamsResponse final :
 ...
 public:
  ...
  ~GetStreamParamsResponse() override;
  explicit PROTOBUF_CONSTEXPR GetStreamParamsResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  GetStreamParamsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const GetStreamParamsResponse& from) {
    GetStreamParamsResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  PROTOBUF_NODISCARD ::bosdyn::api::spot_cam::StreamParams* release_params();
...
class SetStreamParamsRequest final :
 ...
 public:
  ...
  ~SetStreamParamsRequest() override;
  explicit PROTOBUF_CONSTEXPR SetStreamParamsRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SetStreamParamsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SetStreamParamsRequest& from) {
    SetStreamParamsRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class SetStreamParamsResponse final :
 ...
 public:
  ...
  ~SetStreamParamsResponse() override;
  explicit PROTOBUF_CONSTEXPR SetStreamParamsResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SetStreamParamsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SetStreamParamsResponse& from) {
    SetStreamParamsResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class EnableCongestionControlRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bosdyn.api.spot_cam.EnableCongestionControlRequest) */ {
 public:
  inline EnableCongestionControlRequest() : EnableCongestionControlRequest(nullptr) {}
  ~EnableCongestionControlRequest() override;
  explicit PROTOBUF_CONSTEXPR EnableCongestionControlRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  EnableCongestionControlRequest(const EnableCongestionControlRequest& from);
  EnableCongestionControlRequest(EnableCongestionControlRequest&& from) noexcept
    : EnableCongestionControlRequest() {
    *this = ::std::move(from);
  }

  inline EnableCongestionControlRequest& operator=(const EnableCongestionControlRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline EnableCongestionControlRequest& operator=(EnableCongestionControlRequest&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const EnableCongestionControlRequest& default_instance() {
    return *internal_default_instance();
  }
  static inline const EnableCongestionControlRequest* internal_default_instance() {
    return reinterpret_cast<const EnableCongestionControlRequest*>(
               &_EnableCongestionControlRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(EnableCongestionControlRequest& a, EnableCongestionControlRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(EnableCongestionControlRequest* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(EnableCongestionControlRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  EnableCongestionControlRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<EnableCongestionControlRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const EnableCongestionControlRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const EnableCongestionControlRequest& from) {
    EnableCongestionControlRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(EnableCongestionControlRequest* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bosdyn.api.spot_cam.EnableCongestionControlRequest";
  }
  protected:
  explicit EnableCongestionControlRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kHeaderFieldNumber = 1,
    kEnableCongestionControlFieldNumber = 2,
  };
  // .bosdyn.api.RequestHeader header = 1;
  bool has_header() const;
  private:
  ...
  void clear_enable_congestion_control();
  bool enable_congestion_control() const;
  void set_enable_congestion_control(bool value);
  private:
  bool _internal_enable_congestion_control() const;
  void _internal_set_enable_congestion_control(bool value);
  public:
...
class EnableCongestionControlResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bosdyn.api.spot_cam.EnableCongestionControlResponse) */ {
 public:
  inline EnableCongestionControlResponse() : EnableCongestionControlResponse(nullptr) {}
  ~EnableCongestionControlResponse() override;
  explicit PROTOBUF_CONSTEXPR EnableCongestionControlResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  EnableCongestionControlResponse(const EnableCongestionControlResponse& from);
  EnableCongestionControlResponse(EnableCongestionControlResponse&& from) noexcept
    : EnableCongestionControlResponse() {
    *this = ::std::move(from);
  }

  inline EnableCongestionControlResponse& operator=(const EnableCongestionControlResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline EnableCongestionControlResponse& operator=(EnableCongestionControlResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const EnableCongestionControlResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const EnableCongestionControlResponse* internal_default_instance() {
    return reinterpret_cast<const EnableCongestionControlResponse*>(
               &_EnableCongestionControlResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    7;

  friend void swap(EnableCongestionControlResponse& a, EnableCongestionControlResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(EnableCongestionControlResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(EnableCongestionControlResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  EnableCongestionControlResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<EnableCongestionControlResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const EnableCongestionControlResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const EnableCongestionControlResponse& from) {
    EnableCongestionControlResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(EnableCongestionControlResponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bosdyn.api.spot_cam.EnableCongestionControlResponse";
  }
  protected:
  explicit EnableCongestionControlResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
inline ::bosdyn::api::spot_cam::StreamParams_AwbModeEnum StreamParams_AwbMode::_internal_awb() const {
  return static_cast< ::bosdyn::api::spot_cam::StreamParams_AwbModeEnum >(_impl_.awb_);
}
...
inline bool StreamParams::_internal_has_targetbitrate() const {
  return this != internal_default_instance() && _impl_.targetbitrate_ != nullptr;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Int64Value& StreamParams::_internal_targetbitrate() const {
  const ::PROTOBUF_NAMESPACE_ID::Int64Value* p = _impl_.targetbitrate_;
...
inline void StreamParams::unsafe_arena_set_allocated_targetbitrate(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.targetbitrate_);
  }
  _impl_.targetbitrate_ = targetbitrate;
  if (targetbitrate) {
...
inline ::PROTOBUF_NAMESPACE_ID::Int64Value* StreamParams::release_targetbitrate() {
  ...
  ::PROTOBUF_NAMESPACE_ID::Int64Value* temp = _impl_.targetbitrate_;
  _impl_.targetbitrate_ = nullptr;
  ...
  if (targetbitrate) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(targetbitrate));
...
inline bool StreamParams::_internal_has_refreshinterval() const {
  return this != internal_default_instance() && _impl_.refreshinterval_ != nullptr;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Int64Value& StreamParams::_internal_refreshinterval() const {
  const ::PROTOBUF_NAMESPACE_ID::Int64Value* p = _impl_.refreshinterval_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Int64Value&>(
      ::PROTOBUF_NAMESPACE_ID::_Int64Value_default_instance_);
}
...
inline void StreamParams::unsafe_arena_set_allocated_refreshinterval(
    ::PROTOBUF_NAMESPACE_ID::Int64Value* refreshinterval) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.refreshinterval_);
  }
  _impl_.refreshinterval_ = refreshinterval;
  if (refreshinterval) {
...
inline ::PROTOBUF_NAMESPACE_ID::Int64Value* StreamParams::release_refreshinterval() {
  ...
  ::PROTOBUF_NAMESPACE_ID::Int64Value* temp = _impl_.refreshinterval_;
  _impl_.refreshinterval_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::PROTOBUF_NAMESPACE_ID::Int64Value* StreamParams::_internal_mutable_refreshinterval() {
  ...
  if (_impl_.refreshinterval_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Int64Value>(GetArenaForAllocation());
    _impl_.refreshinterval_ = p;
  }
  return _impl_.refreshinterval_;
}
inline ::PROTOBUF_NAMESPACE_ID::Int64Value* StreamParams::mutable_refreshinterval() {
  ::PROTOBUF_NAMESPACE_ID::Int64Value* _msg = _internal_mutable_refreshinterval();
...
inline void StreamParams::set_allocated_refreshinterval(::PROTOBUF_NAMESPACE_ID::Int64Value* refreshinterval) {
  ...
  if (refreshinterval) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(refreshinterval));
    if (message_arena != submessage_arena) {
...
inline bool StreamParams::_internal_has_idrinterval() const {
  return this != internal_default_instance() && _impl_.idrinterval_ != nullptr;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Int64Value& StreamParams::_internal_idrinterval() const {
  const ::PROTOBUF_NAMESPACE_ID::Int64Value* p = _impl_.idrinterval_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Int64Value&>(
      ::PROTOBUF_NAMESPACE_ID::_Int64Value_default_instance_);
}
...
inline void StreamParams::unsafe_arena_set_allocated_idrinterval(
    ::PROTOBUF_NAMESPACE_ID::Int64Value* idrinterval) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.idrinterval_);
  }
  _impl_.idrinterval_ = idrinterval;
  if (idrinterval) {
...
inline ::PROTOBUF_NAMESPACE_ID::Int64Value* StreamParams::release_idrinterval() {
  ...
  ::PROTOBUF_NAMESPACE_ID::Int64Value* temp = _impl_.idrinterval_;
  _impl_.idrinterval_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::PROTOBUF_NAMESPACE_ID::Int64Value* StreamParams::_internal_mutable_idrinterval() {
  ...
  if (_impl_.idrinterval_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Int64Value>(GetArenaForAllocation());
    _impl_.idrinterval_ = p;
  }
  return _impl_.idrinterval_;
}
inline ::PROTOBUF_NAMESPACE_ID::Int64Value* StreamParams::mutable_idrinterval() {
  ::PROTOBUF_NAMESPACE_ID::Int64Value* _msg = _internal_mutable_idrinterval();
...
inline void StreamParams::set_allocated_idrinterval(::PROTOBUF_NAMESPACE_ID::Int64Value* idrinterval) {
  ...
  if (idrinterval) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(idrinterval));
    if (message_arena != submessage_arena) {
...
inline void StreamParams::unsafe_arena_set_allocated_awb(
    ::bosdyn::api::spot_cam::StreamParams_AwbMode* awb) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.awb_);
  }
  _impl_.awb_ = awb;
  if (awb) {
...
inline ::bosdyn::api::spot_cam::StreamParams_AwbMode* StreamParams::release_awb() {
  ...
  ::bosdyn::api::spot_cam::StreamParams_AwbMode* temp = _impl_.awb_;
  _impl_.awb_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bosdyn::api::spot_cam::StreamParams_AwbMode* StreamParams::_internal_mutable_awb() {
  ...
  if (_impl_.awb_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::spot_cam::StreamParams_AwbMode>(GetArenaForAllocation());
    _impl_.awb_ = p;
  }
  return _impl_.awb_;
}
inline ::bosdyn::api::spot_cam::StreamParams_AwbMode* StreamParams::mutable_awb() {
  ::bosdyn::api::spot_cam::StreamParams_AwbMode* _msg = _internal_mutable_awb();
...
inline void StreamParams::set_allocated_awb(::bosdyn::api::spot_cam::StreamParams_AwbMode* awb) {
  ...
  if (awb) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(awb);
    if (message_arena != submessage_arena) {
...
inline const ::bosdyn::api::spot_cam::StreamParams& GetStreamParamsResponse::_internal_params() const {
  const ::bosdyn::api::spot_cam::StreamParams* p = _impl_.params_;
...
inline ::bosdyn::api::spot_cam::StreamParams* GetStreamParamsResponse::release_params() {
  ...
  ::bosdyn::api::spot_cam::StreamParams* temp = _impl_.params_;
  _impl_.params_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bosdyn::api::spot_cam::StreamParams* GetStreamParamsResponse::_internal_mutable_params() {
  ...
  if (_impl_.params_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::spot_cam::StreamParams>(GetArenaForAllocation());
    _impl_.params_ = p;
  }
  return _impl_.params_;
}
inline ::bosdyn::api::spot_cam::StreamParams* GetStreamParamsResponse::mutable_params() {
  ::bosdyn::api::spot_cam::StreamParams* _msg = _internal_mutable_params();
...
// .bosdyn.api.RequestHeader header = 1;
inline bool EnableCongestionControlRequest::_internal_has_header() const {
  return this != internal_default_instance() && _impl_.header_ != nullptr;
}
inline bool EnableCongestionControlRequest::has_header() const {
  return _internal_has_header();
}
inline const ::bosdyn::api::RequestHeader& EnableCongestionControlRequest::_internal_header() const {
  const ::bosdyn::api::RequestHeader* p = _impl_.header_;
  return p != nullptr ? *p : reinterpret_cast<const ::bosdyn::api::RequestHeader&>(
      ::bosdyn::api::_RequestHeader_default_instance_);
}
inline const ::bosdyn::api::RequestHeader& EnableCongestionControlRequest::header() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.spot_cam.EnableCongestionControlRequest.header)
  return _internal_header();
}
inline void EnableCongestionControlRequest::unsafe_arena_set_allocated_header(
    ::bosdyn::api::RequestHeader* header) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.header_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bosdyn.api.spot_cam.EnableCongestionControlRequest.header)
}
inline ::bosdyn::api::RequestHeader* EnableCongestionControlRequest::release_header() {
...
inline ::bosdyn::api::RequestHeader* EnableCongestionControlRequest::unsafe_arena_release_header() {
  // @@protoc_insertion_point(field_release:bosdyn.api.spot_cam.EnableCongestionControlRequest.header)
  
  ::bosdyn::api::RequestHeader* temp = _impl_.header_;
  _impl_.header_ = nullptr;
  return temp;
}
inline ::bosdyn::api::RequestHeader* EnableCongestionControlRequest::_internal_mutable_header() {
...
inline ::bosdyn::api::RequestHeader* EnableCongestionControlRequest::mutable_header() {
  ::bosdyn::api::RequestHeader* _msg = _internal_mutable_header();
  // @@protoc_insertion_point(field_mutable:bosdyn.api.spot_cam.EnableCongestionControlRequest.header)
  return _msg;
}
inline void EnableCongestionControlRequest::set_allocated_header(::bosdyn::api::RequestHeader* header) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.header_);
  }
  ...
  _impl_.header_ = header;
  // @@protoc_insertion_point(field_set_allocated:bosdyn.api.spot_cam.EnableCongestionControlRequest.header)
}

// bool enable_congestion_control = 2;
inline void EnableCongestionControlRequest::clear_enable_congestion_control() {
  _impl_.enable_congestion_control_ = false;
}
inline bool EnableCongestionControlRequest::_internal_enable_congestion_control() const {
  return _impl_.enable_congestion_control_;
}
inline bool EnableCongestionControlRequest::enable_congestion_control() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.spot_cam.EnableCongestionControlRequest.enable_congestion_control)
  return _internal_enable_congestion_control();
}
inline void EnableCongestionControlRequest::_internal_set_enable_congestion_control(bool value) {
  
  _impl_.enable_congestion_control_ = value;
}
inline void EnableCongestionControlRequest::set_enable_congestion_control(bool value) {
  _internal_set_enable_congestion_control(value);
  // @@protoc_insertion_point(field_set:bosdyn.api.spot_cam.EnableCongestionControlRequest.enable_congestion_control)
}
...
// .bosdyn.api.ResponseHeader header = 1;
inline bool EnableCongestionControlResponse::_internal_has_header() const {
  return this != internal_default_instance() && _impl_.header_ != nullptr;
}
inline bool EnableCongestionControlResponse::has_header() const {
  return _internal_has_header();
}
inline const ::bosdyn::api::ResponseHeader& EnableCongestionControlResponse::_internal_header() const {
  const ::bosdyn::api::ResponseHeader* p = _impl_.header_;
  return p != nullptr ? *p : reinterpret_cast<const ::bosdyn::api::ResponseHeader&>(
      ::bosdyn::api::_ResponseHeader_default_instance_);
}
inline const ::bosdyn::api::ResponseHeader& EnableCongestionControlResponse::header() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.spot_cam.EnableCongestionControlResponse.header)
  return _internal_header();
}
inline void EnableCongestionControlResponse::unsafe_arena_set_allocated_header(
    ::bosdyn::api::ResponseHeader* header) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.header_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bosdyn.api.spot_cam.EnableCongestionControlResponse.header)
}
inline ::bosdyn::api::ResponseHeader* EnableCongestionControlResponse::release_header() {
...
inline ::bosdyn::api::ResponseHeader* EnableCongestionControlResponse::unsafe_arena_release_header() {
  // @@protoc_insertion_point(field_release:bosdyn.api.spot_cam.EnableCongestionControlResponse.header)
  
  ::bosdyn::api::ResponseHeader* temp = _impl_.header_;
  _impl_.header_ = nullptr;
  return temp;
}
inline ::bosdyn::api::ResponseHeader* EnableCongestionControlResponse::_internal_mutable_header() {
...
inline ::bosdyn::api::ResponseHeader* EnableCongestionControlResponse::mutable_header() {
  ::bosdyn::api::ResponseHeader* _msg = _internal_mutable_header();
  // @@protoc_insertion_point(field_mutable:bosdyn.api.spot_cam.EnableCongestionControlResponse.header)
  return _msg;
}
inline void EnableCongestionControlResponse::set_allocated_header(::bosdyn::api::ResponseHeader* header) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.header_);
  }
  ...
  _impl_.header_ = header;
  // @@protoc_insertion_point(field_set_allocated:bosdyn.api.spot_cam.EnableCongestionControlResponse.header)
}
