...
//
#ifndef GRPC_bosdyn_2fapi_2fdata_5facquisition_5fplugin_5fservice_2eproto__INCLUDED
#define GRPC_bosdyn_2fapi_2fdata_5facquisition_5fplugin_5fservice_2eproto__INCLUDED

#include "bosdyn/api/data_acquisition_plugin_service.pb.h"
...
class DataAcquisitionPluginService final {
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status AcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::bosdyn::api::AcquirePluginDataResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bosdyn::api::AcquirePluginDataResponse>> AsyncAcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bosdyn::api::AcquirePluginDataResponse>>(AsyncAcquirePluginDataRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bosdyn::api::AcquirePluginDataResponse>> PrepareAsyncAcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::bosdyn::api::AcquirePluginDataResponse>>(PrepareAsyncAcquirePluginDataRaw(context, request, cq));
    }
    ...
    class async_interface {
     public:
      ...
      // Trigger a data acquisition to save metadata and non-image data to the data buffer.
      // Sent by the main DAQ as a result of a data acquisition request from the tablet or a client.
      virtual void AcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest* request, ::bosdyn::api::AcquirePluginDataResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void AcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest* request, ::bosdyn::api::AcquirePluginDataResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // Query the status of a data acquisition.
   ...
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::bosdyn::api::AcquirePluginDataResponse>* AsyncAcquirePluginDataRaw(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::bosdyn::api::AcquirePluginDataResponse>* PrepareAsyncAcquirePluginDataRaw(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status AcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::bosdyn::api::AcquirePluginDataResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bosdyn::api::AcquirePluginDataResponse>> AsyncAcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bosdyn::api::AcquirePluginDataResponse>>(AsyncAcquirePluginDataRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bosdyn::api::AcquirePluginDataResponse>> PrepareAsyncAcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::bosdyn::api::AcquirePluginDataResponse>>(PrepareAsyncAcquirePluginDataRaw(context, request, cq));
    }
    ...
    class async final :
     ...
     public:
      void AcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest* request, ::bosdyn::api::AcquirePluginDataResponse* response, std::function<void(::grpc::Status)>) override;
      void AcquirePluginData(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest* request, ::bosdyn::api::AcquirePluginDataResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::bosdyn::api::AcquirePluginDataResponse>* AsyncAcquirePluginDataRaw(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::bosdyn::api::AcquirePluginDataResponse>* PrepareAsyncAcquirePluginDataRaw(::grpc::ClientContext* context, const ::bosdyn::api::AcquirePluginDataRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_AcquirePluginData_;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // Trigger a data acquisition to save metadata and non-image data to the data buffer.
    // Sent by the main DAQ as a result of a data acquisition request from the tablet or a client.
    virtual ::grpc::Status AcquirePluginData(::grpc::ServerContext* context, const ::bosdyn::api::AcquirePluginDataRequest* request, ::bosdyn::api::AcquirePluginDataResponse* response);
    // Query the status of a data acquisition.
  ...
  class WithAsyncMethod_AcquirePluginData : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_AcquirePluginData() {
      ::grpc::Service::MarkMethodAsync(0);
    }
    ~WithAsyncMethod_AcquirePluginData() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AcquirePluginData(::grpc::ServerContext* /*context*/, const ::bosdyn::api::AcquirePluginDataRequest* /*request*/, ::bosdyn::api::AcquirePluginDataResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestAcquirePluginData(::grpc::ServerContext* context, ::bosdyn::api::AcquirePluginDataRequest* request, ::grpc::ServerAsyncResponseWriter< ::bosdyn::api::AcquirePluginDataResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_AcquirePluginData<WithAsyncMethod_GetStatus<WithAsyncMethod_GetServiceInfo<WithAsyncMethod_CancelAcquisition<Service > > > > AsyncService;
  template <class BaseClass>
  class WithCallbackMethod_AcquirePluginData : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_AcquirePluginData() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::bosdyn::api::AcquirePluginDataRequest, ::bosdyn::api::AcquirePluginDataResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::bosdyn::api::AcquirePluginDataRequest* request, ::bosdyn::api::AcquirePluginDataResponse* response) { return this->AcquirePluginData(context, request, response); }));}
    void SetMessageAllocatorFor_AcquirePluginData(
        ::grpc::MessageAllocator< ::bosdyn::api::AcquirePluginDataRequest, ::bosdyn::api::AcquirePluginDataResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::bosdyn::api::AcquirePluginDataRequest, ::bosdyn::api::AcquirePluginDataResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_AcquirePluginData() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AcquirePluginData(::grpc::ServerContext* /*context*/, const ::bosdyn::api::AcquirePluginDataRequest* /*request*/, ::bosdyn::api::AcquirePluginDataResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* AcquirePluginData(
      ::grpc::CallbackServerContext* /*context*/, const ::bosdyn::api::AcquirePluginDataRequest* /*request*/, ::bosdyn::api::AcquirePluginDataResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_AcquirePluginData<WithCallbackMethod_GetStatus<WithCallbackMethod_GetServiceInfo<WithCallbackMethod_CancelAcquisition<Service > > > > CallbackService;
  typedef CallbackService ExperimentalCallbackService;
  template <class BaseClass>
  class WithGenericMethod_AcquirePluginData : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_AcquirePluginData() {
      ::grpc::Service::MarkMethodGeneric(0);
    }
    ~WithGenericMethod_AcquirePluginData() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AcquirePluginData(::grpc::ServerContext* /*context*/, const ::bosdyn::api::AcquirePluginDataRequest* /*request*/, ::bosdyn::api::AcquirePluginDataResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_AcquirePluginData : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_AcquirePluginData() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_AcquirePluginData() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AcquirePluginData(::grpc::ServerContext* /*context*/, const ::bosdyn::api::AcquirePluginDataRequest* /*request*/, ::bosdyn::api::AcquirePluginDataResponse* /*response*/) override {
    ...
    void RequestAcquirePluginData(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_AcquirePluginData : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_AcquirePluginData() {
      ::grpc::Service::MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->AcquirePluginData(context, request, response); }));
    }
    ~WithRawCallbackMethod_AcquirePluginData() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AcquirePluginData(::grpc::ServerContext* /*context*/, const ::bosdyn::api::AcquirePluginDataRequest* /*request*/, ::bosdyn::api::AcquirePluginDataResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_AcquirePluginData : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_AcquirePluginData() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::bosdyn::api::AcquirePluginDataRequest, ::bosdyn::api::AcquirePluginDataResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::bosdyn::api::AcquirePluginDataRequest, ::bosdyn::api::AcquirePluginDataResponse>* streamer) {
                       return this->StreamedAcquirePluginData(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_AcquirePluginData() override {
      BaseClassMustBeDerivedFromService(this);
    }
    ...
    virtual ::grpc::Status StreamedAcquirePluginData(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::bosdyn::api::AcquirePluginDataRequest,::bosdyn::api::AcquirePluginDataResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_AcquirePluginData<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetServiceInfo<WithStreamedUnaryMethod_CancelAcquisition<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_AcquirePluginData<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetServiceInfo<WithStreamedUnaryMethod_CancelAcquisition<Service > > > > StreamedService;
};
...
#endif  // GRPC_bosdyn_2fapi_2fdata_5facquisition_5fplugin_5fservice_2eproto__INCLUDED
