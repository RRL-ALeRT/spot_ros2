  ...
  class WithCallbackMethod_RegisterService : public BaseClass {
   ...
   public:
    WithCallbackMethod_RegisterService() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::bosdyn::api::RegisterServiceRequest, ::bosdyn::api::RegisterServiceResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::bosdyn::api::RegisterServiceRequest* request, ::bosdyn::api::RegisterServiceResponse* response) { return this->RegisterService(context, request, response); }));}
    void SetMessageAllocatorFor_RegisterService(
        ::grpc::MessageAllocator< ::bosdyn::api::RegisterServiceRequest, ::bosdyn::api::RegisterServiceResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* RegisterService(
      ::grpc::CallbackServerContext* /*context*/, const ::bosdyn::api::RegisterServiceRequest* /*request*/, ::bosdyn::api::RegisterServiceResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_UnregisterService : public BaseClass {
   ...
   public:
    WithCallbackMethod_UnregisterService() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::bosdyn::api::UnregisterServiceRequest, ::bosdyn::api::UnregisterServiceResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::bosdyn::api::UnregisterServiceRequest* request, ::bosdyn::api::UnregisterServiceResponse* response) { return this->UnregisterService(context, request, response); }));}
    void SetMessageAllocatorFor_UnregisterService(
        ::grpc::MessageAllocator< ::bosdyn::api::UnregisterServiceRequest, ::bosdyn::api::UnregisterServiceResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* UnregisterService(
      ::grpc::CallbackServerContext* /*context*/, const ::bosdyn::api::UnregisterServiceRequest* /*request*/, ::bosdyn::api::UnregisterServiceResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_UpdateService : public BaseClass {
   ...
   public:
    WithCallbackMethod_UpdateService() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::bosdyn::api::UpdateServiceRequest, ::bosdyn::api::UpdateServiceResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::bosdyn::api::UpdateServiceRequest* request, ::bosdyn::api::UpdateServiceResponse* response) { return this->UpdateService(context, request, response); }));}
    void SetMessageAllocatorFor_UpdateService(
        ::grpc::MessageAllocator< ::bosdyn::api::UpdateServiceRequest, ::bosdyn::api::UpdateServiceResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* UpdateService(
      ::grpc::CallbackServerContext* /*context*/, const ::bosdyn::api::UpdateServiceRequest* /*request*/, ::bosdyn::api::UpdateServiceResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_RegisterService<WithCallbackMethod_UnregisterService<WithCallbackMethod_UpdateService<Service > > > CallbackService;
