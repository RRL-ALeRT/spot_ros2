...
template<> ::bosdyn::api::ResourceTree* Arena::CreateMaybeMessage<::bosdyn::api::ResourceTree>(Arena*);
...
enum LeaseUseResult_Status : int {
  ...
  LeaseUseResult_Status_LeaseUseResult_Status_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  LeaseUseResult_Status_LeaseUseResult_Status_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum AcquireLeaseResponse_Status : int {
  ...
  AcquireLeaseResponse_Status_AcquireLeaseResponse_Status_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  AcquireLeaseResponse_Status_AcquireLeaseResponse_Status_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum TakeLeaseResponse_Status : int {
  ...
  TakeLeaseResponse_Status_TakeLeaseResponse_Status_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  TakeLeaseResponse_Status_TakeLeaseResponse_Status_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum ReturnLeaseResponse_Status : int {
  ...
  ReturnLeaseResponse_Status_ReturnLeaseResponse_Status_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ReturnLeaseResponse_Status_ReturnLeaseResponse_Status_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class Lease final :
 ...
 public:
  ...
  ~Lease() override;
  explicit PROTOBUF_CONSTEXPR Lease(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void clear_sequence();
  private:
  uint32_t _internal_sequence(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_sequence() const;
  void _internal_add_sequence(uint32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      _internal_mutable_sequence();
  public:
  uint32_t sequence(int index) const;
  void set_sequence(int index, uint32_t value);
  void add_sequence(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      sequence() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      mutable_sequence();
  ...
  private:
  int _internal_client_names_size() const;
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& client_names() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_client_names();
  private:
  const std::string& _internal_client_names(int index) const;
  std::string* _internal_add_client_names();
  public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_epoch(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_epoch(const std::string& value);
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > sequence_;
    mutable std::atomic<int> _sequence_cached_byte_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> client_names_;
...
class ResourceTree final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bosdyn.api.ResourceTree) */ {
 public:
  inline ResourceTree() : ResourceTree(nullptr) {}
  ~ResourceTree() override;
  explicit PROTOBUF_CONSTEXPR ResourceTree(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ResourceTree(const ResourceTree& from);
  ResourceTree(ResourceTree&& from) noexcept
    : ResourceTree() {
    *this = ::std::move(from);
  }

  inline ResourceTree& operator=(const ResourceTree& from) {
    CopyFrom(from);
    return *this;
  }
  inline ResourceTree& operator=(ResourceTree&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ResourceTree& default_instance() {
    return *internal_default_instance();
  }
  static inline const ResourceTree* internal_default_instance() {
    return reinterpret_cast<const ResourceTree*>(
               &_ResourceTree_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(ResourceTree& a, ResourceTree& b) {
    a.Swap(&b);
  }
  inline void Swap(ResourceTree* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ResourceTree* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ResourceTree* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ResourceTree>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ResourceTree& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ResourceTree& from) {
    ResourceTree::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ResourceTree* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bosdyn.api.ResourceTree";
  }
  protected:
  explicit ResourceTree(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kSubResourcesFieldNumber = 2,
    kResourceFieldNumber = 1,
  };
  // repeated .bosdyn.api.ResourceTree sub_resources = 2;
  int sub_resources_size() const;
  private:
  int _internal_sub_resources_size() const;
  public:
  void clear_sub_resources();
  ::bosdyn::api::ResourceTree* mutable_sub_resources(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::ResourceTree >*
      mutable_sub_resources();
  private:
  const ::bosdyn::api::ResourceTree& _internal_sub_resources(int index) const;
  ::bosdyn::api::ResourceTree* _internal_add_sub_resources();
  public:
  const ::bosdyn::api::ResourceTree& sub_resources(int index) const;
  ::bosdyn::api::ResourceTree* add_sub_resources();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::ResourceTree >&
      sub_resources() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::ResourceTree > sub_resources_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr resource_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class LeaseOwner final :
 ...
 public:
  ...
  ~LeaseOwner() override;
  explicit PROTOBUF_CONSTEXPR LeaseOwner(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LeaseOwner* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const LeaseOwner& from) {
    LeaseOwner::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class LeaseUseResult final :
 ...
 public:
  ...
  ~LeaseUseResult() override;
  explicit PROTOBUF_CONSTEXPR LeaseUseResult(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LeaseUseResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const LeaseUseResult& from) {
    LeaseUseResult::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  enum : int {
    kLatestResourcesFieldNumber = 6,
    kOwnerFieldNumber = 2,
    kAttemptedLeaseFieldNumber = 3,
    kPreviousLeaseFieldNumber = 4,
    kLatestKnownLeaseFieldNumber = 5,
    kStatusFieldNumber = 1,
  };
  // repeated .bosdyn.api.Lease latest_resources = 6;
  int latest_resources_size() const;
  private:
  int _internal_latest_resources_size() const;
  public:
  void clear_latest_resources();
  ::bosdyn::api::Lease* mutable_latest_resources(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::Lease >*
      mutable_latest_resources();
  private:
  const ::bosdyn::api::Lease& _internal_latest_resources(int index) const;
  ::bosdyn::api::Lease* _internal_add_latest_resources();
  public:
  const ::bosdyn::api::Lease& latest_resources(int index) const;
  ::bosdyn::api::Lease* add_latest_resources();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::Lease >&
      latest_resources() const;
  ...
  PROTOBUF_NODISCARD ::bosdyn::api::LeaseOwner* release_owner();
  ...
  PROTOBUF_NODISCARD ::bosdyn::api::Lease* release_attempted_lease();
  ...
  PROTOBUF_NODISCARD ::bosdyn::api::Lease* release_previous_lease();
  ...
  // .bosdyn.api.Lease latest_known_lease = 5;
  bool has_latest_known_lease() const;
  private:
  bool _internal_has_latest_known_lease() const;
  public:
  void clear_latest_known_lease();
  const ::bosdyn::api::Lease& latest_known_lease() const;
  PROTOBUF_NODISCARD ::bosdyn::api::Lease* release_latest_known_lease();
  ::bosdyn::api::Lease* mutable_latest_known_lease();
  void set_allocated_latest_known_lease(::bosdyn::api::Lease* latest_known_lease);
  private:
  const ::bosdyn::api::Lease& _internal_latest_known_lease() const;
  ::bosdyn::api::Lease* _internal_mutable_latest_known_lease();
  public:
  void unsafe_arena_set_allocated_latest_known_lease(
      ::bosdyn::api::Lease* latest_known_lease);
  ::bosdyn::api::Lease* unsafe_arena_release_latest_known_lease();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::Lease > latest_resources_;
    ::bosdyn::api::LeaseOwner* owner_;
    ::bosdyn::api::Lease* attempted_lease_;
    ::bosdyn::api::Lease* previous_lease_;
    ::bosdyn::api::Lease* latest_known_lease_;
    int status_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class AcquireLeaseRequest final :
 ...
 public:
  ...
  ~AcquireLeaseRequest() override;
  explicit PROTOBUF_CONSTEXPR AcquireLeaseRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AcquireLeaseRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const AcquireLeaseRequest& from) {
    AcquireLeaseRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class AcquireLeaseResponse final :
 ...
 public:
  ...
  ~AcquireLeaseResponse() override;
  explicit PROTOBUF_CONSTEXPR AcquireLeaseResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AcquireLeaseResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const AcquireLeaseResponse& from) {
    AcquireLeaseResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  PROTOBUF_NODISCARD ::bosdyn::api::LeaseOwner* release_lease_owner();
...
class TakeLeaseRequest final :
 ...
 public:
  ...
  ~TakeLeaseRequest() override;
  explicit PROTOBUF_CONSTEXPR TakeLeaseRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TakeLeaseRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const TakeLeaseRequest& from) {
    TakeLeaseRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class TakeLeaseResponse final :
 ...
 public:
  ...
  ~TakeLeaseResponse() override;
  explicit PROTOBUF_CONSTEXPR TakeLeaseResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TakeLeaseResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const TakeLeaseResponse& from) {
    TakeLeaseResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ReturnLeaseRequest final :
 ...
 public:
  ...
  ~ReturnLeaseRequest() override;
  explicit PROTOBUF_CONSTEXPR ReturnLeaseRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ReturnLeaseRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ReturnLeaseRequest& from) {
    ReturnLeaseRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ReturnLeaseResponse final :
 ...
 public:
  ...
  ~ReturnLeaseResponse() override;
  explicit PROTOBUF_CONSTEXPR ReturnLeaseResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ReturnLeaseResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ReturnLeaseResponse& from) {
    ReturnLeaseResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ListLeasesRequest final :
 ...
 public:
  ...
  ~ListLeasesRequest() override;
  explicit PROTOBUF_CONSTEXPR ListLeasesRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ListLeasesRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ListLeasesRequest& from) {
    ListLeasesRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  enum : int {
    kHeaderFieldNumber = 1,
    kIncludeFullLeaseInfoFieldNumber = 2,
  };
  // .bosdyn.api.RequestHeader header = 1;
  bool has_header() const;
  private:
  ...
  void clear_include_full_lease_info();
  bool include_full_lease_info() const;
  void set_include_full_lease_info(bool value);
  private:
  bool _internal_include_full_lease_info() const;
  void _internal_set_include_full_lease_info(bool value);
  public:
...
class LeaseResource final :
 ...
 public:
  ...
  ~LeaseResource() override;
  explicit PROTOBUF_CONSTEXPR LeaseResource(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LeaseResource* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const LeaseResource& from) {
    LeaseResource::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  private:
  bool _internal_has_stale_time() const;
  public:
  void clear_stale_time();
  const ::PROTOBUF_NAMESPACE_ID::Timestamp& stale_time() const;
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Timestamp* release_stale_time();
  ::PROTOBUF_NAMESPACE_ID::Timestamp* mutable_stale_time();
  void set_allocated_stale_time(::PROTOBUF_NAMESPACE_ID::Timestamp* stale_time);
  private:
  const ::PROTOBUF_NAMESPACE_ID::Timestamp& _internal_stale_time() const;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* _internal_mutable_stale_time();
  public:
  void unsafe_arena_set_allocated_stale_time(
      ::PROTOBUF_NAMESPACE_ID::Timestamp* stale_time);
  ::PROTOBUF_NAMESPACE_ID::Timestamp* unsafe_arena_release_stale_time();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::bosdyn::api::Lease* lease_;
    ::bosdyn::api::LeaseOwner* lease_owner_;
    ::PROTOBUF_NAMESPACE_ID::Timestamp* stale_time_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_bosdyn_2fapi_2flease_2eproto;
...
class ListLeasesResponse final :
 ...
 public:
  ...
  ~ListLeasesResponse() override;
  explicit PROTOBUF_CONSTEXPR ListLeasesResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ListLeasesResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ListLeasesResponse& from) {
    ListLeasesResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  // .bosdyn.api.ResourceTree resource_tree = 3;
  bool has_resource_tree() const;
  private:
  bool _internal_has_resource_tree() const;
  public:
  void clear_resource_tree();
  const ::bosdyn::api::ResourceTree& resource_tree() const;
  PROTOBUF_NODISCARD ::bosdyn::api::ResourceTree* release_resource_tree();
  ::bosdyn::api::ResourceTree* mutable_resource_tree();
  void set_allocated_resource_tree(::bosdyn::api::ResourceTree* resource_tree);
  private:
  const ::bosdyn::api::ResourceTree& _internal_resource_tree() const;
  ::bosdyn::api::ResourceTree* _internal_mutable_resource_tree();
  public:
  void unsafe_arena_set_allocated_resource_tree(
      ::bosdyn::api::ResourceTree* resource_tree);
  ::bosdyn::api::ResourceTree* unsafe_arena_release_resource_tree();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::bosdyn::api::ResponseHeader* header_;
    ::bosdyn::api::ResourceTree* resource_tree_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_bosdyn_2fapi_2flease_2eproto;
...
class RetainLeaseRequest final :
 ...
 public:
  ...
  ~RetainLeaseRequest() override;
  explicit PROTOBUF_CONSTEXPR RetainLeaseRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RetainLeaseRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const RetainLeaseRequest& from) {
    RetainLeaseRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class RetainLeaseResponse final :
 ...
 public:
  ...
  ~RetainLeaseResponse() override;
  explicit PROTOBUF_CONSTEXPR RetainLeaseResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RetainLeaseResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const RetainLeaseResponse& from) {
    RetainLeaseResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void Lease::set_resource(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Lease::set_epoch(ArgT0&& arg0, ArgT... args) {
 
 _impl_.epoch_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Lease::_internal_set_epoch(const std::string& value) {
  ...
  _impl_.epoch_.Set(value, GetArenaForAllocation());
}
inline std::string* Lease::_internal_mutable_epoch() {
  
  return _impl_.epoch_.Mutable(GetArenaForAllocation());
}
...
inline void Lease::set_allocated_epoch(std::string* epoch) {
  ...
  _impl_.epoch_.SetAllocated(epoch, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.epoch_.IsDefault()) {
    _impl_.epoch_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline uint32_t Lease::_internal_sequence(int index) const {
  return _impl_.sequence_.Get(index);
}
inline uint32_t Lease::sequence(int index) const {
  // @@protoc_insertion_point(field_get:bosdyn.api.Lease.sequence)
  return _internal_sequence(index);
}
inline void Lease::set_sequence(int index, uint32_t value) {
  _impl_.sequence_.Set(index, value);
  // @@protoc_insertion_point(field_set:bosdyn.api.Lease.sequence)
}
inline void Lease::_internal_add_sequence(uint32_t value) {
  _impl_.sequence_.Add(value);
}
inline void Lease::add_sequence(uint32_t value) {
...
// repeated string client_names = 4;
inline int Lease::_internal_client_names_size() const {
  return _impl_.client_names_.size();
}
inline int Lease::client_names_size() const {
  return _internal_client_names_size();
}
inline void Lease::clear_client_names() {
  _impl_.client_names_.Clear();
}
inline std::string* Lease::add_client_names() {
  std::string* _s = _internal_add_client_names();
  // @@protoc_insertion_point(field_add_mutable:bosdyn.api.Lease.client_names)
  return _s;
}
inline const std::string& Lease::_internal_client_names(int index) const {
  return _impl_.client_names_.Get(index);
}
inline const std::string& Lease::client_names(int index) const {
  // @@protoc_insertion_point(field_get:bosdyn.api.Lease.client_names)
  return _internal_client_names(index);
}
inline std::string* Lease::mutable_client_names(int index) {
  // @@protoc_insertion_point(field_mutable:bosdyn.api.Lease.client_names)
  return _impl_.client_names_.Mutable(index);
}
inline void Lease::set_client_names(int index, const std::string& value) {
  _impl_.client_names_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:bosdyn.api.Lease.client_names)
}
inline void Lease::set_client_names(int index, std::string&& value) {
  _impl_.client_names_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:bosdyn.api.Lease.client_names)
}
inline void Lease::set_client_names(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.client_names_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:bosdyn.api.Lease.client_names)
}
inline void Lease::set_client_names(int index, const char* value, size_t size) {
  _impl_.client_names_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:bosdyn.api.Lease.client_names)
}
inline std::string* Lease::_internal_add_client_names() {
  return _impl_.client_names_.Add();
}
inline void Lease::add_client_names(const std::string& value) {
  _impl_.client_names_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:bosdyn.api.Lease.client_names)
}
inline void Lease::add_client_names(std::string&& value) {
  _impl_.client_names_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:bosdyn.api.Lease.client_names)
}
inline void Lease::add_client_names(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.client_names_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:bosdyn.api.Lease.client_names)
}
inline void Lease::add_client_names(const char* value, size_t size) {
  _impl_.client_names_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:bosdyn.api.Lease.client_names)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Lease::client_names() const {
  // @@protoc_insertion_point(field_list:bosdyn.api.Lease.client_names)
  return _impl_.client_names_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Lease::mutable_client_names() {
  // @@protoc_insertion_point(field_mutable_list:bosdyn.api.Lease.client_names)
  return &_impl_.client_names_;
}
...
// string resource = 1;
inline void ResourceTree::clear_resource() {
  _impl_.resource_.ClearToEmpty();
}
inline const std::string& ResourceTree::resource() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.ResourceTree.resource)
  return _internal_resource();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResourceTree::set_resource(ArgT0&& arg0, ArgT... args) {
 
 _impl_.resource_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bosdyn.api.ResourceTree.resource)
}
inline std::string* ResourceTree::mutable_resource() {
  std::string* _s = _internal_mutable_resource();
  // @@protoc_insertion_point(field_mutable:bosdyn.api.ResourceTree.resource)
  return _s;
}
inline const std::string& ResourceTree::_internal_resource() const {
  return _impl_.resource_.Get();
}
inline void ResourceTree::_internal_set_resource(const std::string& value) {
  
  _impl_.resource_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceTree::_internal_mutable_resource() {
  
  return _impl_.resource_.Mutable(GetArenaForAllocation());
}
inline std::string* ResourceTree::release_resource() {
  // @@protoc_insertion_point(field_release:bosdyn.api.ResourceTree.resource)
  return _impl_.resource_.Release();
}
inline void ResourceTree::set_allocated_resource(std::string* resource) {
  if (resource != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:bosdyn.api.ResourceTree.resource)
}

// repeated .bosdyn.api.ResourceTree sub_resources = 2;
inline int ResourceTree::_internal_sub_resources_size() const {
  return _impl_.sub_resources_.size();
}
inline int ResourceTree::sub_resources_size() const {
  return _internal_sub_resources_size();
}
inline void ResourceTree::clear_sub_resources() {
  _impl_.sub_resources_.Clear();
}
inline ::bosdyn::api::ResourceTree* ResourceTree::mutable_sub_resources(int index) {
  // @@protoc_insertion_point(field_mutable:bosdyn.api.ResourceTree.sub_resources)
  return _impl_.sub_resources_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::ResourceTree >*
ResourceTree::mutable_sub_resources() {
  // @@protoc_insertion_point(field_mutable_list:bosdyn.api.ResourceTree.sub_resources)
  return &_impl_.sub_resources_;
}
inline const ::bosdyn::api::ResourceTree& ResourceTree::_internal_sub_resources(int index) const {
  return _impl_.sub_resources_.Get(index);
}
inline const ::bosdyn::api::ResourceTree& ResourceTree::sub_resources(int index) const {
  // @@protoc_insertion_point(field_get:bosdyn.api.ResourceTree.sub_resources)
  return _internal_sub_resources(index);
}
inline ::bosdyn::api::ResourceTree* ResourceTree::_internal_add_sub_resources() {
  return _impl_.sub_resources_.Add();
}
inline ::bosdyn::api::ResourceTree* ResourceTree::add_sub_resources() {
  ::bosdyn::api::ResourceTree* _add = _internal_add_sub_resources();
  // @@protoc_insertion_point(field_add:bosdyn.api.ResourceTree.sub_resources)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::ResourceTree >&
ResourceTree::sub_resources() const {
  // @@protoc_insertion_point(field_list:bosdyn.api.ResourceTree.sub_resources)
  return _impl_.sub_resources_;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LeaseOwner::set_client_name(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LeaseOwner::set_user_name(ArgT0&& arg0, ArgT... args) {
...
inline ::bosdyn::api::LeaseUseResult_Status LeaseUseResult::_internal_status() const {
  return static_cast< ::bosdyn::api::LeaseUseResult_Status >(_impl_.status_);
}
...
inline const ::bosdyn::api::LeaseOwner& LeaseUseResult::_internal_owner() const {
  const ::bosdyn::api::LeaseOwner* p = _impl_.owner_;
...
inline ::bosdyn::api::LeaseOwner* LeaseUseResult::release_owner() {
  ...
  ::bosdyn::api::LeaseOwner* temp = _impl_.owner_;
  _impl_.owner_ = nullptr;
...
inline ::bosdyn::api::LeaseOwner* LeaseUseResult::_internal_mutable_owner() {
  ...
  if (_impl_.owner_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::LeaseOwner>(GetArenaForAllocation());
    _impl_.owner_ = p;
  }
  return _impl_.owner_;
}
inline ::bosdyn::api::LeaseOwner* LeaseUseResult::mutable_owner() {
  ::bosdyn::api::LeaseOwner* _msg = _internal_mutable_owner();
...
inline bool LeaseUseResult::_internal_has_attempted_lease() const {
  return this != internal_default_instance() && _impl_.attempted_lease_ != nullptr;
}
...
inline void LeaseUseResult::clear_attempted_lease() {
  if (GetArenaForAllocation() == nullptr && _impl_.attempted_lease_ != nullptr) {
    delete _impl_.attempted_lease_;
  }
  _impl_.attempted_lease_ = nullptr;
}
inline const ::bosdyn::api::Lease& LeaseUseResult::_internal_attempted_lease() const {
  const ::bosdyn::api::Lease* p = _impl_.attempted_lease_;
...
inline void LeaseUseResult::unsafe_arena_set_allocated_attempted_lease(
    ::bosdyn::api::Lease* attempted_lease) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.attempted_lease_);
  }
  _impl_.attempted_lease_ = attempted_lease;
  if (attempted_lease) {
...
inline ::bosdyn::api::Lease* LeaseUseResult::release_attempted_lease() {
  ...
  ::bosdyn::api::Lease* temp = _impl_.attempted_lease_;
  _impl_.attempted_lease_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bosdyn::api::Lease* LeaseUseResult::_internal_mutable_attempted_lease() {
  ...
  if (_impl_.attempted_lease_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::Lease>(GetArenaForAllocation());
    _impl_.attempted_lease_ = p;
  }
  return _impl_.attempted_lease_;
}
inline ::bosdyn::api::Lease* LeaseUseResult::mutable_attempted_lease() {
  ::bosdyn::api::Lease* _msg = _internal_mutable_attempted_lease();
...
inline void LeaseUseResult::set_allocated_attempted_lease(::bosdyn::api::Lease* attempted_lease) {
  ...
  if (attempted_lease) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(attempted_lease);
    if (message_arena != submessage_arena) {
...
inline bool LeaseUseResult::_internal_has_previous_lease() const {
  return this != internal_default_instance() && _impl_.previous_lease_ != nullptr;
}
...
inline void LeaseUseResult::clear_previous_lease() {
  if (GetArenaForAllocation() == nullptr && _impl_.previous_lease_ != nullptr) {
    delete _impl_.previous_lease_;
  }
  _impl_.previous_lease_ = nullptr;
}
inline const ::bosdyn::api::Lease& LeaseUseResult::_internal_previous_lease() const {
  const ::bosdyn::api::Lease* p = _impl_.previous_lease_;
  return p != nullptr ? *p : reinterpret_cast<const ::bosdyn::api::Lease&>(
      ::bosdyn::api::_Lease_default_instance_);
}
...
inline void LeaseUseResult::unsafe_arena_set_allocated_previous_lease(
    ::bosdyn::api::Lease* previous_lease) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.previous_lease_);
  }
  _impl_.previous_lease_ = previous_lease;
  if (previous_lease) {
...
inline ::bosdyn::api::Lease* LeaseUseResult::release_previous_lease() {
  ...
  ::bosdyn::api::Lease* temp = _impl_.previous_lease_;
  _impl_.previous_lease_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bosdyn::api::Lease* LeaseUseResult::_internal_mutable_previous_lease() {
  ...
  if (_impl_.previous_lease_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::Lease>(GetArenaForAllocation());
    _impl_.previous_lease_ = p;
  }
  return _impl_.previous_lease_;
}
inline ::bosdyn::api::Lease* LeaseUseResult::mutable_previous_lease() {
  ::bosdyn::api::Lease* _msg = _internal_mutable_previous_lease();
...
inline void LeaseUseResult::set_allocated_previous_lease(::bosdyn::api::Lease* previous_lease) {
  ...
  if (previous_lease) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(previous_lease);
    if (message_arena != submessage_arena) {
...
// .bosdyn.api.Lease latest_known_lease = 5;
inline bool LeaseUseResult::_internal_has_latest_known_lease() const {
  return this != internal_default_instance() && _impl_.latest_known_lease_ != nullptr;
}
inline bool LeaseUseResult::has_latest_known_lease() const {
  return _internal_has_latest_known_lease();
}
inline void LeaseUseResult::clear_latest_known_lease() {
  if (GetArenaForAllocation() == nullptr && _impl_.latest_known_lease_ != nullptr) {
    delete _impl_.latest_known_lease_;
  }
  _impl_.latest_known_lease_ = nullptr;
}
inline const ::bosdyn::api::Lease& LeaseUseResult::_internal_latest_known_lease() const {
  const ::bosdyn::api::Lease* p = _impl_.latest_known_lease_;
  return p != nullptr ? *p : reinterpret_cast<const ::bosdyn::api::Lease&>(
      ::bosdyn::api::_Lease_default_instance_);
}
inline const ::bosdyn::api::Lease& LeaseUseResult::latest_known_lease() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.LeaseUseResult.latest_known_lease)
  return _internal_latest_known_lease();
}
inline void LeaseUseResult::unsafe_arena_set_allocated_latest_known_lease(
    ::bosdyn::api::Lease* latest_known_lease) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.latest_known_lease_);
  }
  _impl_.latest_known_lease_ = latest_known_lease;
  if (latest_known_lease) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bosdyn.api.LeaseUseResult.latest_known_lease)
}
inline ::bosdyn::api::Lease* LeaseUseResult::release_latest_known_lease() {
  
  ::bosdyn::api::Lease* temp = _impl_.latest_known_lease_;
  _impl_.latest_known_lease_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bosdyn::api::Lease* LeaseUseResult::unsafe_arena_release_latest_known_lease() {
  // @@protoc_insertion_point(field_release:bosdyn.api.LeaseUseResult.latest_known_lease)
  
  ::bosdyn::api::Lease* temp = _impl_.latest_known_lease_;
  _impl_.latest_known_lease_ = nullptr;
  return temp;
}
inline ::bosdyn::api::Lease* LeaseUseResult::_internal_mutable_latest_known_lease() {
  
  if (_impl_.latest_known_lease_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::Lease>(GetArenaForAllocation());
    _impl_.latest_known_lease_ = p;
  }
  return _impl_.latest_known_lease_;
}
inline ::bosdyn::api::Lease* LeaseUseResult::mutable_latest_known_lease() {
  ::bosdyn::api::Lease* _msg = _internal_mutable_latest_known_lease();
  // @@protoc_insertion_point(field_mutable:bosdyn.api.LeaseUseResult.latest_known_lease)
  return _msg;
}
inline void LeaseUseResult::set_allocated_latest_known_lease(::bosdyn::api::Lease* latest_known_lease) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.latest_known_lease_;
  }
  if (latest_known_lease) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(latest_known_lease);
    if (message_arena != submessage_arena) {
      latest_known_lease = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, latest_known_lease, submessage_arena);
    }
  ...
  _impl_.latest_known_lease_ = latest_known_lease;
  // @@protoc_insertion_point(field_set_allocated:bosdyn.api.LeaseUseResult.latest_known_lease)
}

// repeated .bosdyn.api.Lease latest_resources = 6;
inline int LeaseUseResult::_internal_latest_resources_size() const {
  return _impl_.latest_resources_.size();
}
inline int LeaseUseResult::latest_resources_size() const {
  return _internal_latest_resources_size();
}
inline void LeaseUseResult::clear_latest_resources() {
  _impl_.latest_resources_.Clear();
}
inline ::bosdyn::api::Lease* LeaseUseResult::mutable_latest_resources(int index) {
  // @@protoc_insertion_point(field_mutable:bosdyn.api.LeaseUseResult.latest_resources)
  return _impl_.latest_resources_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::Lease >*
LeaseUseResult::mutable_latest_resources() {
  // @@protoc_insertion_point(field_mutable_list:bosdyn.api.LeaseUseResult.latest_resources)
  return &_impl_.latest_resources_;
}
inline const ::bosdyn::api::Lease& LeaseUseResult::_internal_latest_resources(int index) const {
  return _impl_.latest_resources_.Get(index);
}
inline const ::bosdyn::api::Lease& LeaseUseResult::latest_resources(int index) const {
  // @@protoc_insertion_point(field_get:bosdyn.api.LeaseUseResult.latest_resources)
  return _internal_latest_resources(index);
}
inline ::bosdyn::api::Lease* LeaseUseResult::_internal_add_latest_resources() {
  return _impl_.latest_resources_.Add();
}
inline ::bosdyn::api::Lease* LeaseUseResult::add_latest_resources() {
  ::bosdyn::api::Lease* _add = _internal_add_latest_resources();
  // @@protoc_insertion_point(field_add:bosdyn.api.LeaseUseResult.latest_resources)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bosdyn::api::Lease >&
LeaseUseResult::latest_resources() const {
  // @@protoc_insertion_point(field_list:bosdyn.api.LeaseUseResult.latest_resources)
  return _impl_.latest_resources_;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AcquireLeaseRequest::set_resource(ArgT0&& arg0, ArgT... args) {
...
inline ::bosdyn::api::AcquireLeaseResponse_Status AcquireLeaseResponse::_internal_status() const {
  return static_cast< ::bosdyn::api::AcquireLeaseResponse_Status >(_impl_.status_);
}
...
inline bool AcquireLeaseResponse::_internal_has_lease_owner() const {
  return this != internal_default_instance() && _impl_.lease_owner_ != nullptr;
}
...
inline void AcquireLeaseResponse::clear_lease_owner() {
  if (GetArenaForAllocation() == nullptr && _impl_.lease_owner_ != nullptr) {
    delete _impl_.lease_owner_;
  }
  _impl_.lease_owner_ = nullptr;
}
inline const ::bosdyn::api::LeaseOwner& AcquireLeaseResponse::_internal_lease_owner() const {
  const ::bosdyn::api::LeaseOwner* p = _impl_.lease_owner_;
  return p != nullptr ? *p : reinterpret_cast<const ::bosdyn::api::LeaseOwner&>(
      ::bosdyn::api::_LeaseOwner_default_instance_);
}
...
inline void AcquireLeaseResponse::unsafe_arena_set_allocated_lease_owner(
    ::bosdyn::api::LeaseOwner* lease_owner) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.lease_owner_);
  }
  _impl_.lease_owner_ = lease_owner;
  if (lease_owner) {
...
inline ::bosdyn::api::LeaseOwner* AcquireLeaseResponse::release_lease_owner() {
  ...
  ::bosdyn::api::LeaseOwner* temp = _impl_.lease_owner_;
  _impl_.lease_owner_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bosdyn::api::LeaseOwner* AcquireLeaseResponse::_internal_mutable_lease_owner() {
  ...
  if (_impl_.lease_owner_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::LeaseOwner>(GetArenaForAllocation());
    _impl_.lease_owner_ = p;
  }
  return _impl_.lease_owner_;
}
inline ::bosdyn::api::LeaseOwner* AcquireLeaseResponse::mutable_lease_owner() {
  ::bosdyn::api::LeaseOwner* _msg = _internal_mutable_lease_owner();
...
inline void AcquireLeaseResponse::set_allocated_lease_owner(::bosdyn::api::LeaseOwner* lease_owner) {
  ...
  if (lease_owner) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(lease_owner);
    if (message_arena != submessage_arena) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TakeLeaseRequest::set_resource(ArgT0&& arg0, ArgT... args) {
...
inline ::bosdyn::api::TakeLeaseResponse_Status TakeLeaseResponse::_internal_status() const {
  return static_cast< ::bosdyn::api::TakeLeaseResponse_Status >(_impl_.status_);
}
...
inline ::bosdyn::api::ReturnLeaseResponse_Status ReturnLeaseResponse::_internal_status() const {
  return static_cast< ::bosdyn::api::ReturnLeaseResponse_Status >(_impl_.status_);
}
...
// bool include_full_lease_info = 2;
inline void ListLeasesRequest::clear_include_full_lease_info() {
  _impl_.include_full_lease_info_ = false;
}
inline bool ListLeasesRequest::_internal_include_full_lease_info() const {
  return _impl_.include_full_lease_info_;
}
inline bool ListLeasesRequest::include_full_lease_info() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.ListLeasesRequest.include_full_lease_info)
  return _internal_include_full_lease_info();
}
inline void ListLeasesRequest::_internal_set_include_full_lease_info(bool value) {
  
  _impl_.include_full_lease_info_ = value;
}
inline void ListLeasesRequest::set_include_full_lease_info(bool value) {
  _internal_set_include_full_lease_info(value);
  // @@protoc_insertion_point(field_set:bosdyn.api.ListLeasesRequest.include_full_lease_info)
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LeaseResource::set_resource(ArgT0&& arg0, ArgT... args) {
...
// .google.protobuf.Timestamp stale_time = 4;
inline bool LeaseResource::_internal_has_stale_time() const {
  return this != internal_default_instance() && _impl_.stale_time_ != nullptr;
}
inline bool LeaseResource::has_stale_time() const {
  return _internal_has_stale_time();
}
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& LeaseResource::_internal_stale_time() const {
  const ::PROTOBUF_NAMESPACE_ID::Timestamp* p = _impl_.stale_time_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Timestamp&>(
      ::PROTOBUF_NAMESPACE_ID::_Timestamp_default_instance_);
}
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& LeaseResource::stale_time() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.LeaseResource.stale_time)
  return _internal_stale_time();
}
inline void LeaseResource::unsafe_arena_set_allocated_stale_time(
    ::PROTOBUF_NAMESPACE_ID::Timestamp* stale_time) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.stale_time_);
  }
  _impl_.stale_time_ = stale_time;
  if (stale_time) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bosdyn.api.LeaseResource.stale_time)
}
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* LeaseResource::release_stale_time() {
  
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.stale_time_;
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* LeaseResource::unsafe_arena_release_stale_time() {
  // @@protoc_insertion_point(field_release:bosdyn.api.LeaseResource.stale_time)
  
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.stale_time_;
  _impl_.stale_time_ = nullptr;
  return temp;
}
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* LeaseResource::_internal_mutable_stale_time() {
  
  if (_impl_.stale_time_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Timestamp>(GetArenaForAllocation());
    _impl_.stale_time_ = p;
  }
  return _impl_.stale_time_;
}
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* LeaseResource::mutable_stale_time() {
  ::PROTOBUF_NAMESPACE_ID::Timestamp* _msg = _internal_mutable_stale_time();
  // @@protoc_insertion_point(field_mutable:bosdyn.api.LeaseResource.stale_time)
  return _msg;
}
inline void LeaseResource::set_allocated_stale_time(::PROTOBUF_NAMESPACE_ID::Timestamp* stale_time) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.stale_time_);
  }
  if (stale_time) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(stale_time));
    if (message_arena != submessage_arena) {
      stale_time = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, stale_time, submessage_arena);
    }
  ...
  _impl_.stale_time_ = stale_time;
  // @@protoc_insertion_point(field_set_allocated:bosdyn.api.LeaseResource.stale_time)
}
...
inline ::bosdyn::api::LeaseResource* ListLeasesResponse::add_resources() {
  ::bosdyn::api::LeaseResource* _add = _internal_add_resources();
...
// .bosdyn.api.ResourceTree resource_tree = 3;
inline bool ListLeasesResponse::_internal_has_resource_tree() const {
  return this != internal_default_instance() && _impl_.resource_tree_ != nullptr;
}
inline bool ListLeasesResponse::has_resource_tree() const {
  return _internal_has_resource_tree();
}
inline void ListLeasesResponse::clear_resource_tree() {
  if (GetArenaForAllocation() == nullptr && _impl_.resource_tree_ != nullptr) {
    delete _impl_.resource_tree_;
  }
  _impl_.resource_tree_ = nullptr;
}
inline const ::bosdyn::api::ResourceTree& ListLeasesResponse::_internal_resource_tree() const {
  const ::bosdyn::api::ResourceTree* p = _impl_.resource_tree_;
  return p != nullptr ? *p : reinterpret_cast<const ::bosdyn::api::ResourceTree&>(
      ::bosdyn::api::_ResourceTree_default_instance_);
}
inline const ::bosdyn::api::ResourceTree& ListLeasesResponse::resource_tree() const {
  // @@protoc_insertion_point(field_get:bosdyn.api.ListLeasesResponse.resource_tree)
  return _internal_resource_tree();
}
inline void ListLeasesResponse::unsafe_arena_set_allocated_resource_tree(
    ::bosdyn::api::ResourceTree* resource_tree) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.resource_tree_);
  }
  _impl_.resource_tree_ = resource_tree;
  if (resource_tree) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bosdyn.api.ListLeasesResponse.resource_tree)
}
inline ::bosdyn::api::ResourceTree* ListLeasesResponse::release_resource_tree() {
  
  ::bosdyn::api::ResourceTree* temp = _impl_.resource_tree_;
  _impl_.resource_tree_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bosdyn::api::ResourceTree* ListLeasesResponse::unsafe_arena_release_resource_tree() {
  // @@protoc_insertion_point(field_release:bosdyn.api.ListLeasesResponse.resource_tree)
  
  ::bosdyn::api::ResourceTree* temp = _impl_.resource_tree_;
  _impl_.resource_tree_ = nullptr;
  return temp;
}
inline ::bosdyn::api::ResourceTree* ListLeasesResponse::_internal_mutable_resource_tree() {
  
  if (_impl_.resource_tree_ == nullptr) {
    auto* p = CreateMaybeMessage<::bosdyn::api::ResourceTree>(GetArenaForAllocation());
    _impl_.resource_tree_ = p;
  }
  return _impl_.resource_tree_;
}
inline ::bosdyn::api::ResourceTree* ListLeasesResponse::mutable_resource_tree() {
  ::bosdyn::api::ResourceTree* _msg = _internal_mutable_resource_tree();
  // @@protoc_insertion_point(field_mutable:bosdyn.api.ListLeasesResponse.resource_tree)
  return _msg;
}
inline void ListLeasesResponse::set_allocated_resource_tree(::bosdyn::api::ResourceTree* resource_tree) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.resource_tree_;
  }
  if (resource_tree) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(resource_tree);
    if (message_arena != submessage_arena) {
      resource_tree = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, resource_tree, submessage_arena);
    }
  ...
  _impl_.resource_tree_ = resource_tree;
  // @@protoc_insertion_point(field_set_allocated:bosdyn.api.ListLeasesResponse.resource_tree)
}
...
inline void RetainLeaseResponse::clear_lease_use_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.lease_use_result_ != nullptr) {
    delete _impl_.lease_use_result_;
  }
...
inline void RetainLeaseResponse::set_allocated_lease_use_result(::bosdyn::api::LeaseUseResult* lease_use_result) {
  ...
  if (lease_use_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(lease_use_result);
    if (message_arena != submessage_arena) {
