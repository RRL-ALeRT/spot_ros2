...
class ImageService final {
 public:
  ...
  template <class BaseClass>
  class WithCallbackMethod_ListImageSources : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_ListImageSources() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::bosdyn::api::ListImageSourcesRequest, ::bosdyn::api::ListImageSourcesResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::bosdyn::api::ListImageSourcesRequest* request, ::bosdyn::api::ListImageSourcesResponse* response) { return this->ListImageSources(context, request, response); }));}
    void SetMessageAllocatorFor_ListImageSources(
        ::grpc::MessageAllocator< ::bosdyn::api::ListImageSourcesRequest, ::bosdyn::api::ListImageSourcesResponse>* allocator) {
    ...
    ~WithCallbackMethod_ListImageSources() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListImageSources(::grpc::ServerContext* /*context*/, const ::bosdyn::api::ListImageSourcesRequest* /*request*/, ::bosdyn::api::ListImageSourcesResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* ListImageSources(
      ::grpc::CallbackServerContext* /*context*/, const ::bosdyn::api::ListImageSourcesRequest* /*request*/, ::bosdyn::api::ListImageSourcesResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_GetImage : public BaseClass {
   ...
   public:
    WithCallbackMethod_GetImage() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::bosdyn::api::GetImageRequest, ::bosdyn::api::GetImageResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::bosdyn::api::GetImageRequest* request, ::bosdyn::api::GetImageResponse* response) { return this->GetImage(context, request, response); }));}
    void SetMessageAllocatorFor_GetImage(
        ::grpc::MessageAllocator< ::bosdyn::api::GetImageRequest, ::bosdyn::api::GetImageResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* GetImage(
      ::grpc::CallbackServerContext* /*context*/, const ::bosdyn::api::GetImageRequest* /*request*/, ::bosdyn::api::GetImageResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_ListImageSources<WithCallbackMethod_GetImage<Service > > CallbackService;
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_ListImageSources : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_ListImageSources() {
      ::grpc::Service::MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->ListImageSources(context, request, response); }));
    }
    ~WithRawCallbackMethod_ListImageSources() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListImageSources(::grpc::ServerContext* /*context*/, const ::bosdyn::api::ListImageSourcesRequest* /*request*/, ::bosdyn::api::ListImageSourcesResponse* /*response*/) override {
